...
DISTDIR = /home/guillaume/Cours/syntheseImages/ProjetSynthese/.tmp/projet1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) -lGLEW -lGL -lGLU -lm /usr/lib/libGL.so -lQt5OpenGL -lQt5Widgets -lQt5Gui -lQt5Xml -lQt5Core -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt -D_REENTRANT -Wall -W -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
